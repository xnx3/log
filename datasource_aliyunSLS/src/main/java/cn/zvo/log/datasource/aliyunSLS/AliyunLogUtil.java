...
//		this.logstore = logstore;
	 ...
	 * @throws LogException
	 */
	public PutLogsResponse save(String logstore, String topic, String source, LogItem logItem) throws LogException{
	 ...
	 * @throws LogException
	 */
	public void cacheLog(String logstore, LogItem logItem) throws LogException{
		if(logItem == null){
			return;
		}
	 ...
	 * @throws LogException
	 */
	public PutLogsResponse cacheCommit(String logstore) throws LogException{
		PutLogsResponse r = saveByGroup(logstore, "", "", logGroupCache);
...
//			}
	 ...
	 * @throws LogException
	 */
	public PutLogsResponse saveByGroup(String logstore, String topic, String source, Vector<LogItem> logGroup) throws LogException{
        PutLogsRequest req2 = new PutLogsRequest(project, logstore, topic, source, logGroup);
        return client.PutLogs(req2);
	}
	 ...
	 * @throws LogException 
	 */
	public long queryCount(String logstore, String query, String topic, int startTime, int endTime) throws LogException{
	 ...
	 * @throws LogException 
	 */
	public ArrayList<QueriedLog> queryList(String logstore, String query, String topic, int startTime, int endTime, int offset, int line, boolean reverse) throws LogException{
